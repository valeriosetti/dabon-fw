...
void fsmc_init()
{
	...
	CLEAR_BIT(FSMC_Bank1->BTCR[0], FSMC_BCR1_WREN);	// Write is disabled
	...
	MODIFY_REG(FSMC_Bank1E->BWTR[1], FSMC_BTR1_ACCMOD_Msk, (10UL << FSMC_BTR1_ACCMOD_Pos));	// access mode C
	MODIFY_REG(FSMC_Bank1E->BWTR[1], FSMC_BTR1_ADDSET_Msk, (4UL << FSMC_BTR1_ADDSET_Pos));	// ADDSET ~ 4*6ns = 24ns
	MODIFY_REG(FSMC_Bank1E->BWTR[1], FSMC_BTR1_DATAST_Msk, (31UL << FSMC_BTR1_DATAST_Pos));	// DATAST ~ 31*6ns = 186ns
	MODIFY_REG(FSMC_Bank1E->BWTR[1], FSMC_BTR1_BUSTURN_Msk, (15UL << FSMC_BTR1_BUSTURN_Pos));	// BUSTURN ~ 15*6ns = 90ns
}
